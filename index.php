...
<body background="Images/bg_grey.jpg">

<body>
<table width="960" border="0" align="center" cellpadding="0" cellspacing="0" style="background:#E2DEDF;">
  <tr>
    <td><img src="Images/logotipo.jpg" width="960" height="110" alt="logo" /></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><a href="#" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('home','','Images/btn_home02.jpg',1)"><img src="Images/btn_home02.jpg" alt="home" name="home" width="192" height="45" border="0" id="home" /></a></td>
        
        <td><a href="contact.html" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('contact','','Images/btn_contact02.jpg',1)"><img src="Images/btn_contact01.jpg" alt="contact" name="contact" width="192" height="45" border="0" id="contact" /></a></td>
        <td><img src="Images/btn_vacio.png" alt="clientes" name="clientes" width="192" height="45" border="0" id="clientes" /></a></td>
        <td><img src="Images/btn_vacio.png" alt="contacto" name="contacto" width="192" height="45" border="0" id="contacto" /></td>
        <td><img src="Images/btn_vacio.png" alt="contacto" name="contacto" width="192" height="45" border="0" id="contacto" /></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td><img src="Images/banner.jpg" width="960" height="270" alt="banner" /></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" class="blanco">
      <tr>
      <td>
      </td>
...
<strong>Country:</strong> Several<br/>
  ...
  <tr>
    <td><h3>e-mail: sellingmystampcollection@gmail.com<br/>
    Copyright  Fegui and Grace - 2015</h3>
